...
public class InfoService {
    ...
    public void addFields(CircleList<BaseField> field) {
        ...
        field.add(new StreetField("Компьютеры", 15, "\u001b[35m", null, new Price(260, 150, new RentPrice(22, 120, 1150)), false, false));
        field.add(new StreetField("Интернет", 16, "\u001b[35m", null, new Price(260, 150, new RentPrice(22, 110, 1150)), false, false));
        field.add(new StreetField("Сотовая связь", 17, "\u001b[35m", null, new Price(280, 150, new RentPrice(24, 120, 1200)), false, false));
        ...
        field.add(new StreetField("Курортная зона", 34, "\u001b[37m", null, new Price(350, 200, new RentPrice(35, 175, 1500)), false, false));
        field.add(new StreetField("Гостиничный комплекс", 35, "\u001b[37m", null, new Price(400, 200, new RentPrice(50, 200, 2000)), false, false));
    }
